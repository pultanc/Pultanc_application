...
content = content.replace(
  '<div className="absolute bottom-4 left-4 right-4 text-center text-[9px] text-zinc-400 font-medium bg-black/60 backdrop-blur-sm p-1.5 rounded-xl border border-white/5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">\n            Click the download button to export the ultra-sharp native PNG\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n  );\n}',
  '<div className="absolute bottom-4 left-4 right-4 text-center text-[9px] text-zinc-400 font-medium bg-black/60 backdrop-blur-sm p-1.5 rounded-xl border border-white/5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">\n            Click the download button to export the ultra-sharp native PNG\n          </div>\n        </div>\n' + copyLinkBlock + '      </div>\n    </div>\n  </div>\n  );\n}'
);
